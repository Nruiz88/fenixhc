...
import { Menu, LogOut, LayoutDashboard, User, Users, DollarSign, Image, Bell, Calendar, Home, ChevronRight, Settings } from 'lucide-react';

const NAV_ITEMS = [
  { label: 'Dashboard', href: '/padre/dashboard', icon: LayoutDashboard },
  { label: 'Mi Perfil', href: '/padre/perfil', icon: User },
  { label: 'Mis Hijos', href: '/padre/hijos', icon: Users },
  { label: 'Pagos', href: '/padre/pagos', icon: DollarSign },
  { label: 'Fotos', href: '/padre/fotos', icon: Image },
  { label: 'Reservas', href: '/padre/reservas', icon: Calendar },
  { label: 'Notificaciones', href: '/padre/notificaciones', icon: Bell },
  { label: 'Configuración', href: '/padre/configuracion', icon: Settings },
];
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-5 border-b border-gray-800">
        <Link href="/padre/dashboard" className="flex items-center gap-3">
